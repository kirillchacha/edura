    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".categories__slider")) new swiper_core_Swiper(".categories__slider", {
                ...
                navigation: {
                    prevEl: ".categories__left",
                    nextEl: ".categories__right"
                },
                on: {}
            });
            if (document.querySelector(".read-together__slider")) new swiper_core_Swiper(".read-together__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".read-together__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".read-together__left",
                    nextEl: ".read-together__right"
                },
                on: {}
            });
            if (document.querySelector(".right-inspires__slider")) new swiper_core_Swiper(".right-inspires__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".right-inspires__pagination",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".top-history__slider")) {
                new swiper_core_Swiper(".top-history__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                ...
                function handleHoverEffects() {
                    const slides = document.querySelectorAll(".top-history__slide");
            ...
            if (document.querySelector(".right-slider-history__slider")) new swiper_core_Swiper(".right-slider-history__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                speed: 800,
                pagination: {
                    el: ".right-slider-history__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".slider-one-choose")) new swiper_core_Swiper(".slider-one-choose", {
            ...
            if (document.querySelector(".slider-two-choose")) new swiper_core_Swiper(".slider-two-choose", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2.62,
            ...
            if (document.querySelector(".top-alumni-one__slider")) new swiper_core_Swiper(".top-alumni-one__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                pagination: {
                    el: ".top-alumni-one__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-alumni-one__left",
                    nextEl: ".top-alumni-one__right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".popular-courses__slider")) new swiper_core_Swiper(".popular-courses__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                pagination: {
                    el: ".popular-courses__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".top-courses__slider")) new swiper_core_Swiper(".top-courses__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                speed: 800,
                pagination: {
                    el: ".top-courses__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-courses__left",
                    nextEl: ".top-courses__right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".bottom-courses__slider")) new swiper_core_Swiper(".bottom-courses__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                speed: 800,
                pagination: {
                    el: ".bottom-courses__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".bottom-courses__left",
                    nextEl: ".bottom-courses__right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: "auto",
            ...
            if (document.querySelector(".bottom-cooperation__slider")) new swiper_core_Swiper(".bottom-cooperation__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                speed: 800,
                pagination: {
                    el: ".bottom-cooperation__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".bottom-cooperation__left",
                    nextEl: ".bottom-cooperation__right"
                },
                on: {}
            });
            if (document.querySelector(".team__content")) {
                let rightSlider;
                const leftSlider = new swiper_core_Swiper(".left-team__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                    ...
                    on: {
                        ...
                        slideChange: ({realIndex}) => {
                            rightSlider.slideTo(realIndex);
                        }
                    }
                });
                rightSlider = new swiper_core_Swiper(".right-team__slider", {
                    ...
                    speed: 800,
                    pagination: {
                        el: ".right-team__pagination",
                        clickable: true
                    },
                    navigation: {
                        prevEl: ".right-team__left",
                        nextEl: ".right-team__right"
                    },
                    thumbs: {
                        swiper: leftSlider
                    },
            ...
            const instituteSlider = () => {
                const SELECTORS = {
                    wrapper: ".js-institute",
                    nav: ".js-institute-nav",
                    slider: ".js-institute-slider",
                    scrollBtn: ".js-institute-scroll-btn",
                    pagination: ".js-institute-pagination",
                    prev: ".js-institute-prev",
                    next: ".js-institute-next"
                };
                const CLASSNAMES = {
                    navActiveState: "content-institute__item--active-state"
                };
                const $wrappers = document.querySelectorAll(SELECTORS.wrapper);
                if (!$wrappers.length) return;
                const onChangeSlide = ({activeIndex, $navItems}) => {
                    $navItems.forEach((($navItem, index) => {
                        $navItem.classList.toggle(CLASSNAMES.navActiveState, index === activeIndex);
                    }));
                };
                const handleNavClick = ({swiper, clickedIndex}) => {
                    if (clickedIndex === swiper.activeIndex || clickedIndex >= swiper.slides.length) return;
                    swiper.slideTo(clickedIndex);
                };
                $wrappers.forEach(($wrapper => {
                    const $slider = $wrapper.querySelector(SELECTORS.slider);
                    const $nav = $wrapper.querySelector(SELECTORS.nav);
                    const $pagination = $wrapper.querySelector(SELECTORS.pagination);
                    const $prev = $wrapper.querySelector(SELECTORS.prev);
                    const $next = $wrapper.querySelector(SELECTORS.next);
                    let $navItems = null;
                    if (!$slider) return;
                    new swiper_core_Swiper($slider, {
                        ...
                        speed: 800,
                        freeMode: {
                            enabled: window.innerWidth > 991.98,
                            momentumBounceRatio: .1,
                            momentumRatio: .4
                        },
                        pagination: {
                        ...
                        on: {
                            init: swiper => {
                                ...
                                $navItems[activeIndex]?.classList.add(CLASSNAMES.navActiveState);
                                $navItems.forEach(($item => {
                                    const $link = $item.querySelector("a, button");
                                    $link.addEventListener("click", (e => {
                                        e.preventDefault();
                                        const clickedIndex = $navItems.indexOf($item);
                                        handleNavClick({
                                            swiper,
                                            clickedIndex
                                        });
                            ...
                            click: (swiper, e) => {
                                const {target} = e;
                                if (!target.closest(SELECTORS.scrollBtn)) return;
                                e.preventDefault();
            ...
            instituteSlider();
            const specializationsSlider = () => {
                const SELECTORS = {
                    wrapper: ".js-specializations",
                    nav: ".js-specializations-nav",
                    slider: ".js-specializations-slider",
                    pagination: ".js-specializations-pagination",
                    prev: ".js-specializations-prev",
                    next: ".js-specializations-next"
                };
                const CLASSNAMES = {
                    navActiveState: "content-specializations__item--active-state"
                };
                const $wrappers = document.querySelectorAll(SELECTORS.wrapper);
                if (!$wrappers.length) return;
                const onChangeSlide = ({activeIndex, $navItems}) => {
...
***************************************************************************** */
        ...
        da.init();
        const starContainers = document.querySelectorAll(".rating-alumni");
        function generateStars(starCount) {
            let starHTML = "<ul class='rating-alumni__list'>";
            for (let i = 0; i < starCount; i++) starHTML += `<li><div class="rating-alumni__item _icon-star-ratting"></div></li>`;
            for (let i = starCount; i < 5; i++) starHTML += `<li><div class="rating-alumni__item rating-alumni__item--empty _icon-star-ratting"></div></li>`;
            starHTML += "</ul>";
            return starHTML;
        }
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            menuActiveHeader();
            initAnimatedText();
            playVideoYoutubeIframe();
            textRotateAnimationOne();
            textRotateAnimationTwo();
            textRotateAnimationThree();
        }));
        ...
        function initAnimatedText() {
            const textContainers = document.querySelectorAll("[data-word-animate]");
            const observer = new IntersectionObserver((entries => {
                entries.forEach((entry => {
                    if (entry.isIntersecting) {
                        const target = entry.target;
                        if (!target.classList.contains("_animated")) animateWords(target);
                    }
                }));
            }), {
                threshold: .1
            ...
            textContainers.forEach((textContainer => {
                ...
                words.forEach(((word, index) => {
                    ...
                    if (textContainer.dataset.animateDuration && textContainer.dataset.animateDelay) {
                        wordSpan.style.opacity = 0;
                        wordSpan.style.transition = `opacity ${textContainer.dataset.animateDuration}s ease-in-out, transform ${textContainer.dataset.animateDuration}s ease-in-out`;
                    }
                    wordSpan.dataset.index = index;
                    textContainer.appendChild(wordSpan);
                    if (index !== words.length - 1) textContainer.appendChild(document.createTextNode(" "));
                }));
                observer.observe(textContainer);
            }));
            function animateWords(container) {
                container.classList.add("_animated");
                const delay = parseFloat(container.dataset.animateDelay) || 0;
                parseFloat(container.dataset.animateDuration);
                const wordElements = container.querySelectorAll("span");
                wordElements.forEach(((word, i) => {
                    if (container.dataset.animateDuration && container.dataset.animateDelay) setTimeout((() => {
                        word.style.opacity = 1;
                    }), delay * 1e3 + i * 100);
                }));
            }
        }
        function playVideoYoutubeIframe() {
            const playButton = document.getElementById("play-button");
            const videoContainer = document.getElementById("video-container");
            const imageYoutubeIframe = document.querySelector(".left-alumni-two__bg");
            if (playButton && videoContainer && imageYoutubeIframe) playButton.addEventListener("click", (function(e) {
                e.preventDefault();
                videoContainer.style.display = "block";
                playButton.style.display = "none";
                imageYoutubeIframe.style.display = "none";
            }));
        }
        document.addEventListener("DOMContentLoaded", playVideoYoutubeIframe);
        function initMap() {
            let pos = {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const contactContent = document.querySelector(".contact-us__content");
            if (closeButton && contactContent) closeButton.addEventListener("click", (function() {
                contactContent.remove();
            }));
        }));
        function textRotateAnimationOne() {
            const dataTextOne = document.querySelector("[data-rotate-text-animation-one]");
            if (dataTextOne) {
                const textRotate = dataTextOne.innerText || dataTextOne.textContent;
                dataTextOne.innerHTML = "";
                for (let i = 0; i < textRotate.length; i++) {
                    let span = document.createElement("span");
                    span.innerHTML = textRotate[i];
                    dataTextOne.appendChild(span);
                    span.style.transform = `rotate(${14.5 * i}deg)`;
                }
            }
        }
        function textRotateAnimationTwo() {
            const dataTextTwo = document.querySelector("[data-rotate-text-animation-two]");
            if (dataTextTwo) {
                const textRotate = dataTextTwo.innerText || dataTextTwo.textContent;
                dataTextTwo.innerHTML = "";
                for (let i = 0; i < textRotate.length; i++) {
                    let span = document.createElement("span");
                    span.innerHTML = textRotate[i];
                    dataTextTwo.appendChild(span);
                    span.style.transform = `rotate(${20 * i}deg)`;
                }
            }
        }
        function textRotateAnimationThree() {
            const dataTextThree = document.querySelector("[data-rotate-text-animation-three]");
            if (dataTextThree) {
                const textRotate = dataTextThree.innerText || dataTextThree.textContent;
                dataTextThree.innerHTML = "";
                for (let i = 0; i < textRotate.length; i++) {
                    let span = document.createElement("span");
                    span.innerHTML = textRotate[i];
                    dataTextThree.appendChild(span);
                    span.style.transform = `rotate(${14.5 * i}deg)`;
                }
            }
        }
